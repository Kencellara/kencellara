<?php
  add_action('wp_enqueue_scripts', wp_enqueue_style('archive-style', get_template_directory_uri() . '/css/archive.css', array('habakiri', 'common-style'), '1.0.12'));
  ...
  add_action('wp_enqueue_scripts', wp_enqueue_style('category-style', get_template_directory_uri() . '/css/category.css', array(), '1.0.12.1'));
  add_action('wp_enqueue_scripts', wp_enqueue_style('sp_category-style', get_template_directory_uri() . '/css/sp_category.css', array(), '1.0.12.1'));
