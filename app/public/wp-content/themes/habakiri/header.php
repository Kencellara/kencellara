...
<head prefix="og: http://ogp.me/ns# <?php echo ( is_single() || is_page() ) ? 'fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#' : 'fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#' ?>">
	...
	<?php
		...
		add_action('wp_enqueue_scripts', wp_enqueue_style('sp_common-style', get_template_directory_uri() .'/scss-css/sp_common.css', array(), '3.0'));
		add_action('wp_enqueue_scripts', wp_enqueue_style('header-style', get_template_directory_uri() . '/scss-css/header.css', array(), '3.0.1'));
		...
		add_action('wp_enqueue_scripts', wp_enqueue_style('sidebar-style', get_template_directory_uri() . '/scss-css/sidebar.css', array(), '3.0'));
