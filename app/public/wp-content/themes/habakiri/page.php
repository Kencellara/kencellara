...
add_action('wp_enqueue_scripts', wp_enqueue_style('page-style', get_template_directory_uri() .'/css/page.css', array(), '2.0.1'));
add_action('wp_enqueue_scripts', wp_enqueue_style('sp_page-style', get_template_directory_uri() .'/css/sp_page.css', array(), '2.0'));
...
add_action('wp_enqueue_scripts', wp_enqueue_style('collabo_coverage-style', get_template_directory_uri() . '/css/collabo_coverage.css', array(), '2.0.1'));
