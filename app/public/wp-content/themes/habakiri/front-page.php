<?php
	add_action('wp_enqueue_scripts', wp_enqueue_style('home-style', get_template_directory_uri() . '/css/home.css', array('habakiri', 'common-style'), '1.0.7'));
	add_action('wp_enqueue_scripts', wp_enqueue_style('sp_home-style', get_template_directory_uri() . '/css/sp_home.css', array(), '1.0.7'));
