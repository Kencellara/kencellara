<?php
	add_action('wp_enqueue_scripts', wp_enqueue_style('single-style', get_template_directory_uri() . '/scss-css/single.css', array('habakiri', 'common-style'), '3.0.3'));
	add_action('wp_enqueue_scripts', wp_enqueue_style('sp_single-style', get_template_directory_uri() . '/scss-css/sp_single.css', array(), '3.0.2'));
